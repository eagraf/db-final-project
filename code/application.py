...
while(1):
    ...
    if val == 'exit':
        ...
        mapObj.generateZips(dbObj.getEssentialDensity, nyMap)
        ...
        mapObj.generateZips(dbObj.getEssentialDensityDelta, nyMap)
